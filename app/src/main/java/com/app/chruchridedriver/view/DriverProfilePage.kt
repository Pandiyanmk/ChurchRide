...
class DriverProfilePage : AppCompatActivity(), ClickedAdapterInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pullDownAnimateRefreshLayout.setOnRefreshListener(object :
            ...
            override fun onRefresh() {
                if (cu.isNetworkAvailable(this@DriverProfilePage)) {
        ...
        imageUri?.let { imageUri ->
            storageReference?.let {
                ...
                GlobalScope.launch {
                    ...
                    if (file.exists()) {
                        val compressedImageFile = Compressor.compress(this@DriverProfilePage, file)
                        documentUploadStatusViewModel.uploadDocumentOrImage(
                            Uri.fromFile(
                                compressedImageFile
                            ).path!!
                        )
