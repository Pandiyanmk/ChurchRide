...
import com.app.chruchridedriver.data.model.UploadResponse
...
interface RetrofitClientAndEndPoints {
    ...
    suspend fun getAcceptResponse(
        @Query("ride_id") ride_id: String, @Query("driverId") driverId: String
    ): Response<AcceptRideResponse>

    @GET("login.php")
    suspend fun getDriverIds(
    ...
    companion object {
        ...
        val baseUrl = "http://192.168.0.105/church/"
