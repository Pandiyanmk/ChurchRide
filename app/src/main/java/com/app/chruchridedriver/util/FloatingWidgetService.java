...
import com.app.chruchridedriver.view.DriverTripPage;
...
public class FloatingWidgetService extends Service implements View.OnClickListener {
    ...
    private View addRemoveView(LayoutInflater inflater) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            paramRemove = new WindowManager.LayoutParams(WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.TYPE_PHONE, WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE, PixelFormat.TRANSLUCENT);
        } else {
            paramRemove = new WindowManager.LayoutParams(WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY, WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE, PixelFormat.TRANSLUCENT);
        }
    ...
    private void addFloatingWidgetView(LayoutInflater inflater) {
        ...
        collapsedView = mFloatingWidgetView.findViewById(R.id.collapsed_ivs);
    }
    ...
    private void implementClickListeners() {
        mFloatingWidgetView.findViewById(R.id.collapsed_ivs).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private boolean isViewCollapsed() {
        return mFloatingWidgetView == null || mFloatingWidgetView.findViewById(R.id.collapse_views).getVisibility() == View.VISIBLE;
    }
